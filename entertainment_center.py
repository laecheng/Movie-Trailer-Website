...
forrest_gump = media.Movie("Forrest Gump",
                           "A inspirational story about the life of Forrest Gump who has intellectual deficiency",
                           "https://upload.wikimedia.org/wikipedia/en/6/67/Forrest_Gump_poster.jpg",
                           "https://youtu.be/hMxENmG3Tyw")

the_shawshank_redemption = media.Movie("The Shawshank Redemption",
                                       "A prominent banker unjustly convicted of murder spends many years in the Shawshank prison",
                                       "https://upload.wikimedia.org/wikipedia/en/8/81/ShawshankRedemptionMoviePoster.jpg",
                                       "https://youtu.be/K_tLp7T6U1c")

shutter_island =  media.Movie("Shutter Island",
                            "As Marshal Teddy Daniels arrives at the asylum for the criminally insane on Shutter Island what starts as a routine investigation quickly takes a sinister turn",
...
movies_list = [avatar, inception, iron_man, forrest_gump, the_shawshank_redemption, shutter_island]
